...
export class FullBoilerPlateParser {
    ...
    generateC(): string {
        ...
        return `#include <stdio.h>
                ...
                int main() {
                    FILE *file = fopen("${ PROBLEMS_DIR_PATH  }/${this.problemName.toLowerCase().replace(" ", "-")}/tests/inputs/##INPUT_FILE_INDEX##.txt", "r");
                    vector<string> lines;
                    string line;
    ...
    int main() {
      std::ifstream file("${PROBLEMS_DIR_PATH }/${this.problemName.toLowerCase().replace(" ", "-")}/tests/inputs/##INPUT_FILE_INDEX##.txt");
    ...
    public class Main {
        ...
        public static void main(String[] args) {
            String filePath = "${PROBLEMS_DIR_PATH}/${this.problemName.toLowerCase().replace(" ", "-")}/tests/inputs/##INPUT_FILE_INDEX##.txt"; 
    ...
    fn main() -> io::Result<()> {
      let input = read_to_string("${PROBLEMS_DIR_PATH }/${this.problemName.toLowerCase().replace(" ", "-")}/tests/inputs/##INPUT_FILE_INDEX##.txt")?;
